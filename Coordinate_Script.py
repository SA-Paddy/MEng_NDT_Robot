...
def plot_coordinates(neg_width, pos_width, width, length, resolution):
...
def main():
    ...
    plot_coordinates(neg_width, pos_width, width, length, resolution)
    return coordinates


# This is the line of code  that calls for the function 'main' to  run
#main()